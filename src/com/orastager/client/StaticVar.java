...
import com.orastager.client.RichTextToolbar.Strings;
...
public class StaticVar {
	...
	//Tab Panel
	static TabLayoutPanel tabPanel = new TabLayoutPanel(2, Unit.EM);
	...
	static int nodeTextBoxMaxTextWidth = 75;
	static double charPixelSize = 6.5;
	
	static SimpleRemoteLogHandler remoteLogger = new SimpleRemoteLogHandler();
	static Logger logger = Logger.getLogger("DMA");
	
	static TreeItem tiDrag = new TreeItem();
	
    static Random randomGenerator = new Random();
	static HashSet<String> randomNumArr = new HashSet<String>();
	static String randomNum;
	
    public static HashMap<TreeItem, Node> locate = new HashMap<TreeItem, Node>();
    ...
    static HashMap<RichTextArea, TreeItem> locateTextTab = new HashMap<RichTextArea, TreeItem>();
    static HashMap<TextArea, TreeItem> locateUrlTab = new HashMap<TextArea, TreeItem>();
    static HashMap<TextArea, TreeItem> locateCodeTab = new HashMap<TextArea, TreeItem>();
	...
	static CustomPopupPanel moveNodeTreePopPanel = new CustomPopupPanel(false, true, true, true);
	static Tree moveNodeTree = new Tree(); //treeResources
	static VerticalPanel moveNodeTreeVPanel = new VerticalPanel(); 
	static CustomScrollPanel moveNodeTreeScrPanel = new CustomScrollPanel(moveNodeTree);
	static SuggestBox moveNodeSuggestBox = new SuggestBox(oracle);
	static int moveNodeTreeScrWidth = Window.getClientWidth()/2;
	static int moveNodeTreeScrHeight = Window.getClientHeight()/2;
	static Button moveNodeSelectButton = new Button("Select");
	
	static CustomPopupPanel addNodePairPanel = new CustomPopupPanel(true, true, true, true);
	...
	static CustomPopupPanel jsonPopupPanel = new CustomPopupPanel(true, true, true, true);
	static VerticalPanel jsonFlowPanel = new VerticalPanel();
	
	static CustomPopupPanel msgPopPanel = new CustomPopupPanel(false, true, false, false);
	...
	static HashMap<TreeItem, TreeItem> locateMoveNodeMap = new HashMap<TreeItem, TreeItem>();
	static HashMap<TreeItem, TreeItem> locateMoveNodeMapRev = new HashMap<TreeItem, TreeItem>();
	...
	static Image expandButton = new Image(StaticVar.menuResources.expand());
	  ...
	  public interface Properties extends Constants {
	      String clientId();
	  }
	  
	 static Properties properties = (Properties) GWT.create(Properties.class);
	// Root Tree Item
	...
	static TreeItem root_ti = new TreeItem(root_node);
	...
	//Searched Nodes
	static ArrayList<TreeItem> searchList = new ArrayList<TreeItem>();
	static ArrayList<TreeItem> searchListMoveTree = new ArrayList<TreeItem>();
	
	//searchBox, suggestBox
	final static SuggestBox suggestBox = new SuggestBox(oracle);
	...
	static CustomPopupPanel previewPopup = new CustomPopupPanel(false, false, true, false);
