...
public class Commands {
    ...
    public static Command plusCommand = new Command() {
    	public void execute() {
    		...
    		TreeItem ti_child = new TreeItem(child_node);
    ...
    public static Command exportHtmlCommand = new Command(){
    	public void execute() {
    	    exportHtml(StaticVar.locate.get(StaticVar.currNode.ti.getParentItem()).text+".html", StaticVar.currNode.text.replace("\n", "<br>"));
    		Menus.popupPanel.hide();
    	}
    };
    		  ...
    		  if (DmaUtil.isTextNode(StaticVar.currNode)==false){
				  ...
				  if (StaticVar.textTabsArr.contains(StaticVar.currNode.nodeTextArea) == true){
					  ...
					  final Command cmdTabClose = new Command(){
						  public void execute() {
							  SaveDma.copyCodesFromTabs();
							  DmaUtil.tabClose(StaticVar.locate.get(StaticVar.locateCodeTab.get(tabTextArea)));
					    ...
					    codeType.addChangeHandler(new ChangeHandler() {
							...
							public void onChange(ChangeEvent event) {
								...
								DmaUtil.setCodeNodeImg(StaticVar.locate.get(StaticVar.locateCodeTab.get(tabTextArea)), codeType.getItemText(codeType.getSelectedIndex()));
    ...
    //Features
    public static Command tutorialCommand = new Command() {
    	public void execute() {
        	//JSFunctions.openURL(StaticVar.APP_BASE_URL+"/index.html?fileId=0BwVzf8LNyklCUGZYQXAyblJydmM", "Mem Tree tutorial");
    		JSFunctions.openURL("http://datamagicagent.blogspot.com/2014/06/tutorial.html", "Mem Tree tutorial");
    	}
    };
	...
	public static Command sourceCodeCommand = new Command(){
		@Override
		public void execute() {
			// TODO Auto-generated method stub
			JSFunctions.openURL("https://github.com/nandaemani/Mem-Tree", "Source code");
		}
	};
