...
public class TopMenu {
	...
	public static void createMenu(){
	    ...
	    MenuItem tutorialMI = new MenuItem("Tutorial", Commands.tutorialCommand);
	    tutorialMI.setTitle("Mem-tree tutorial/documentation");
	    StaticVar.menuBarHelp.addItem(tutorialMI);
	    ...
	    MenuItem sourceCodeMI = new MenuItem("Source Code", Commands.sourceCodeCommand);
	    sourceCodeMI.setTitle("Source code of mem-tree");
	    //StaticVar.menuBarHelp.addItem(sourceCodeMI);
