...
public class SaveDma {
	...
	public static void copyCodesFromTabs(){
	    for (Entry<RichTextArea, TreeItem> entry : StaticVar.locateTextTab.entrySet()) {
	    ...
	    for (Entry<TextArea, TreeItem> entry : StaticVar.locateUrlTab.entrySet()) {
	    	if (StaticVar.locate.get(entry.getValue()) != null){
		...
		for (Map.Entry<TextArea, TreeItem> entry : StaticVar.locateCodeTab.entrySet()) {
	    	if (StaticVar.locate.get(entry.getValue()) != null){
